...
namespace MyCustomUmbracoProject.Custom
{
    public class Configuration
    {
        ...
        public static bool SendEmailV2(string recipient, string cc, string bcc, string subject, string body, string sender, string senderName, List<string> attachment, string smtpServer,
            ...
            using (SmtpClient smtpClient = new SmtpClient())
            {
                ...
                using (MailMessage message = new MailMessage())
                {
                    ...
                    if (attachment != null)
                    {
                        ...
                        {
                            if (System.IO.File.Exists(MediaVehiclepath + attachment[i]))
                            {
                                message.Attachments.Add(new Attachment(Path.Combine(MediaVehiclepath, attachment[i])));
                            }
                        }
                    }
